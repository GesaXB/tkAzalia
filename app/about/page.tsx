...
export const metadata: Metadata = {
  ...
  description:
    "Kenali lebih jauh TK Azalia: sejarah berdiri, visi misi, program unggulan, dan komitmen kami dalam memberikan pendidikan anak usia dini yang berkualitas dan Islami.",
  keywords: [
    "profil TK Azalia",
    "tentang TK Azalia",
    "visi misi TK Azalia",
  ...
  openGraph: {
    title: "Tentang Kami - Profil TK Azalia",
    description:
      "Kenali lebih jauh TK Azalia: visi misi, program unggulan, dan komitmen pendidikan Islami berkualitas.",
    url: "/about",
  },
};
