...
import { ArrowLeft, Calendar, ImageIcon, Share2, MessageCircle, Send, User, ChevronRight, Trash2, Edit2, X, Check } from "lucide-react";
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <section className="mt-20">
              ...
              {!user ? (
                ...
                <form onSubmit={handleSubmitComment} className="mb-16 bg-gray-50 p-6 md:p-8 rounded-[2rem] border border-gray-100">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end">
                      <button
                        ...
                        className="flex items-center gap-3 px-8 py-3 rounded-full bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-all disabled:opacity-50"
                      >
                  ...
                  comments.map((comment) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        {editingComment === comment.komentar_id ? (
                          <div className="mt-2 space-y-3">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <button
                                onClick={() => handleUpdateComment(comment.komentar_id)}
                                disabled={isUpdating}
                          ...
                          <p className="text-sm text-gray-600 leading-relaxed bg-gray-50 p-4 rounded-2xl rounded-tl-none inline-block border border-gray-100/50">
                            {comment.isi}
                          </p>
                        )}
                      </div>
