      ...
      <div className="rounded-xl border border-gray-100 bg-white overflow-hidden shadow-sm">
        <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-white to-emerald-50/30">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-bold text-gray-900 text-lg">Daftar Pendaftar</h2>
          ...
          <div className="flex flex-col xl:flex-row items-stretch xl:items-center gap-4">
            ...
            <div className="relative flex-1" ref={suggestionRef}>
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-2xl border border-slate-200 text-sm focus:ring-4 focus:ring-[#01793B]/10 focus:border-[#01793B] outline-none transition-all bg-slate-50/50"
              />
                  ...
                  {suggestions.map((s) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-slate-700 truncate group-hover:text-[#01793B]">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <select
                ...
                className="px-4 py-2.5 rounded-2xl border border-slate-200 text-sm bg-white focus:ring-4 focus:ring-[#01793B]/10 focus:border-[#01793B] outline-none transition-all font-bold text-slate-600 cursor-pointer"
              >
                      ...
                      <tr key={item.siswa_id} className="hover:bg-slate-50/40 transition-colors group">
                        <td className="px-6 py-6">
                          <div className="flex items-center gap-4">
                            <div className="w-11 h-11 shrink-0 rounded-2xl bg-slate-50 text-slate-400 flex items-center justify-center font-black text-sm group-hover:bg-emerald-50 group-hover:text-[#01793B] transition-all duration-300 ring-1 ring-slate-100 group-hover:ring-emerald-100">
                        ...
                        <td className="px-6 py-6 text-center">
                          <Link
                            ...
                            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-2xl bg-slate-900 text-white font-bold text-[11px] uppercase tracking-widest hover:bg-[#01793B] transition-all duration-300 active:scale-95 shadow-md shadow-slate-200 hover:shadow-emerald-200"
                          >
                            Detail
